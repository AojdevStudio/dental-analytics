...
class TestSheetsReader:
    ...
    def test_get_sheet_data_success(self):
        ...
        with patch('backend.sheets_reader.service_account'), \
    ...
    def test_get_sheet_data_no_data(self):
    ...
    def test_get_sheet_data_service_not_initialized(self):
        """Test sheet data retrieval when service is not initialized."""
        with patch('backend.sheets_reader.service_account') as mock_sa:
            mock_sa.Credentials.from_service_account_file.side_effect = Exception("Error")
    ...
    def test_get_sheet_data_empty_range(self):
    ...
    def test_get_sheet_data_headers_only(self):
    ...
    def test_constants(self):
        ...
        assert SheetsReader.SPREADSHEET_ID == '1lTDek2zvQNYwlIXss6yW9uawASAWbDIKR1E_FKFTxQ8'
        assert SheetsReader.SCOPES == ['https://www.googleapis.com/auth/spreadsheets.readonly']